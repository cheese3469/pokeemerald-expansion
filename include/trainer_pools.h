...
#define MON_POOL_TAG_POOLONE        1 << POOL_TAG_POOLONE
#define MON_POOL_TAG_POOLTWO        1 << POOL_TAG_POOLTWO
#define MON_POOL_TAG_POOLTHREE      1 << POOL_TAG_POOLTHREE
