...
const struct PoolRules gPoolRulesetsList[] = {
    ...
    [POOL_RULESET_SUPPORT_DOUBLES] = {
        ...
        .tagMaxMembers[POOL_TAG_ACE] = 1,
        .tagMaxMembers[POOL_TAG_SUPPORT] = 1,
        .tagMaxMembers[POOL_TAG_POOLONE] = 1,
        .tagMaxMembers[POOL_TAG_POOLTWO] = 1,
        .tagMaxMembers[POOL_TAG_POOLTHREE] = 1,
        .tagRequired[POOL_TAG_SUPPORT] = TRUE,
        .tagRequired[POOL_TAG_POOLONE] = TRUE,
        .tagRequired[POOL_TAG_POOLTWO] = TRUE,
        .tagRequired[POOL_TAG_POOLTHREE] = TRUE,
    },
};
